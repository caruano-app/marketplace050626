...
export function CategoryMenu({ categories }: CategoryMenuProps) {
  return (
    <nav className="border-t border-black/10 bg-[#f6b900]" aria-label="Categorias principais">
      <div className="mx-auto flex h-[58px] max-w-[1440px] items-center gap-4 px-4 md:gap-8 md:px-8">
        ...
        <div className="scrollbar-hide flex min-w-0 flex-1 items-center gap-6 overflow-x-auto whitespace-nowrap">
          {categories.map((category) => (
            <a
              className="shrink-0 text-lg font-black uppercase text-neutral-950"
          ...
          <a className="shrink-0 text-lg font-black uppercase text-neutral-950" href="/insumos">
            Insumos
            <span className="ml-1 text-xl">v</span>
          </a>
          <a className="shrink-0 text-lg font-black uppercase text-neutral-950" href="/clube">
            Clube
            <span className="ml-1 text-xl">v</span>
          </a>
        </div>
